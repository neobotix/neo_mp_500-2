...
def generate_launch_description():
    ...
    config = os.path.join(get_package_share_directory('neo_mp_500-2'),'configs/lidar/sick/s300','s300_1.yaml')
    config1 = os.path.join(get_package_share_directory('neo_mp_500-2'),'configs/lidar/sick/s300','s300_filter.yaml')
